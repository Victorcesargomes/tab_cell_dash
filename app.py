        ...
        dbc.Row([
            dbc.Col([
                dbc.Nav([
                    ...
                    dbc.NavItem(dbc.NavLink([html.I(className='fa fa-home dbc'), "\tLOJA 1"], href="/loja1", active=True, style={'text-align': 'center'})),

                    dbc.NavItem(html.Br()),
                    
                    dbc.NavItem(dbc.NavLink([html.I(className='fa fa-home dbc'), "\tLOJA 2"], href="/loja2", active=True, style={'text-align': 'center'})),
                   
                    dbc.NavItem(html.Br()),

                    dbc.NavItem(dbc.NavLink([html.I(className='fa fa-home dbc'), "\tLOJA 3"], href="/loja3", active=True, style={'text-align': 'center'})),
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            dcc.Graph(id='graph20', className='dbc card_padrao', config=config_graph)
                        ]),
                    ])
                ])
            ], style=tab_card)
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            dcc.Graph(id='graph21', className='dbc card_padrao', config=config_graph)
                        ]),
                    ])
                ])
            ], style=tab_card)
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            dcc.Graph(id='graph22', className='dbc card_padrao', config=config_graph)
                        ]),
                    ])
                ])
            ], style=tab_card)
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            dcc.Graph(id='graph23', className='dbc card_padrao', config=config_graph)
                        ]),
                    ])
                ])
            ], style=tab_card)
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            dcc.Graph(id='graph24', className='dbc card_padrao', config=config_graph)
                        ], sm=12, lg=12),
                    ])
                ])
            ], style=tab_card)
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            dcc.Graph(id='graph30', className='dbc card_padrao', config=config_graph)
                        ]),
                    ])
                ])
            ], style=tab_card)
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            dcc.Graph(id='graph31', className='dbc card_padrao', config=config_graph)
                        ]),
                    ])
                ])
            ], style=tab_card)
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            dcc.Graph(id='graph32', className='dbc card_padrao', config=config_graph)
                        ]),
                    ])
                ])
            ], style=tab_card)
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            dcc.Graph(id='graph33', className='dbc card_padrao', config=config_graph)
                        ]),
                    ])
                ])
            ], style=tab_card)
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            dcc.Graph(id='graph34', className='dbc card_padrao', config=config_graph)
                        ], sm=12, lg=12),
                    ])
                ])
            ], style=tab_card)
